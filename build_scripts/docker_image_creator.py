""" Script to create Sagemaker Chainer Docker images

    Usage:
        python docker_image_creator.py binary_path gpu|cpu chainer_version python_version
"""
import argparse
import glob
import os
...
def create_docker_image(binary_path, processor, framework_version, python_version, final_image_repository, final_image_tags):
    ...
    Args:
        ...
        framework_version (str): chainer version i.e 4.0.0
        python_version (str): (i.e. 3.6.5 or 2.7.4)
        binary_path (str): path to where the binary is.
        final_image_repository (str): name of final repo. If None, 'preprod-chainer' will be used
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Build Sagemaker Chainer Docker Images')
    ...
    parser.add_argument('framework_version', help='Chainer framework version (i.e. 4.0.0)')
